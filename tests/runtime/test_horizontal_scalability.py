...
class HorizontalEvidenceTests(unittest.TestCase):
    ...
    def test_orchestrator_contract_is_fail_closed_and_run_scoped(self):
        ...
        self.assertIn("driver_container_reason=", source)
        self.assertIn("driver_exit_code=", source)
        self.assertIn("executor_container_reasons=", source)
        self.assertIn("minio_restarts=", source)
        self.assertIn('"OOMKilled"', source)
